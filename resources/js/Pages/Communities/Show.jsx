...
export default function Show(props){
    ...
    return (
        <> 
            ...
            auth={props.auth}
            errors={props.errors}
            header={<><h2 className="font-semibold text-xl text-gray-800 leading-tight justify-center items-center flex dark:text-gray-200">Üdvözlünk a {community.name} fórumon!</h2>
            ...
            <section className='flex flex-col md:flex-row m-2 p-2'>
                ...
                {posts.data.map(({ id, title, description, username, slug, upvotes, votes, comments, created_at }) => (
                    <div className="m-2 p-2 bg-white dark:bg-gray-600 rounded-lg">
