                                ...
                                {forums.data.map(({ id, name, slug }) => (
                                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <Link href={route('forums.edit', slug)} className="font-medium bg-blue-500 hover:bg-blue-400 text-white py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">Edit</Link>
                                                <Link href={route('forums.destroy', slug)} method="delete" className="ml-4 font-medium bg-red-500 hover:bg-red-400 text-white py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded">Delete</Link>
                                            </td>
                                        </tr>
                                    ))}
